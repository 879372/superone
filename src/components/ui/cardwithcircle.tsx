...
const CardWithCircle = ({ imageSrc, description }: { imageSrc: string; description: string }) => {
  return (
    <div className="group flex flex-col items-center bg-transparent rounded-2xl p-4 max-w-[110px]  md:max-w-[150px] cursor-pointer">
      ...
      <p className="flex flex-wrap mt-4 text-center text-gray-700 text-xs sm:text-sm transition-all duration-300 group-hover:font-semibold">
        {description}
      </p>
    </div>
  );
